...
allprojects {
    ...
    project.plugins.withType(JavaPlugin::class) {
        dependencies {
            ...
            "compileOnly"("biz.aQute.bnd:biz.aQute.bnd.annotation:7.2.1")
            "compileOnly"("com.google.code.findbugs:findbugs-annotations:3.0.1")
            "testCompileOnly"("biz.aQute.bnd:biz.aQute.bnd.annotation:7.2.1")
...
sonarqube {
    properties {
        property("sonar.projectKey", "NaveenParmar0_secureshield-extensions")
        property("sonar.organization", "NaveenParmar0")
